  ...
  "use strict";
	...
	$(document).ready(function () {
	    ...
	    table = $("#table").DataTable({
	      ...
	      order: [],
	      ajax: {
	        url: BASE_URL + "admin/study/study-material-list",
	        type: "POST",
	      },
	  ...
	  var study_material_id = $('.study_material_id').val();
	    ...
	    $(document).on("click", ".submit_contant_type", function (e) 
	    {
	       ...
	       if(contant_type)
	       {
	       		window.location.href = BASE_URL+"admin/study/add-material-file/"+study_material_id+"/"+contant_type;
	       }
	       else
	       {
	...
	function update_section_position()
	{
        ...
        $.ajax({
          url: BASE_URL+"admin/Study_Material/change_section_position",
          type: 'POST',
	...
	function update_section_contant_position()
	{
        ...
        $.ajax({
          url: BASE_URL+"admin/Study_Material/change_section_contant_position",
          type: 'POST',
          data: { position:position,},
          success: function(response)
          {

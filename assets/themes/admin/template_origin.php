            ...
            <div class="main-sidebar sidebar-style-2" tabindex="1" >
               <aside id="sidebar-wrapper">
                  ...
                  <ul class="sidebar-menu">
                     ...
                     <li class="dropdown <?php echo (strstr(uri_string(), 'admin/study') OR (strstr(uri_string(), 'admin/extcourse')) OR (strstr(uri_string(), 'admin/adcourse')) ) ? ' active' : ''; ?>">
                        <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                        ...
                        <ul class="dropdown-menu">
                           ...
                           <li class="<?php echo (uri_string() == 'admin/adcourse') ? 'active' : ''; ?>">
                              <a href="<?php echo base_url('admin/adcourse'); ?>" class="nav-link"> 환급 강의
                              </a>
                           </li>                             
                     ...
                     if(is_loged_in_user_is_subadmin() == FALSE)
                     {
                      ?>
                        ...
                        <li class="dropdown<?php echo ((strstr(uri_string(), 'admin/settings/menu_item') OR uri_string() == 'admin/settings/menu_list') OR (strstr(uri_string(), 'admin/pages')) OR (strstr(uri_string(), 'admin/blog')) OR (strstr(uri_string(), 'admin/custom_fields')) OR (strstr(uri_string(), 'admin/testimonial')) OR (uri_string() == 'admin/footer') ) ? ' active' : ''; ?>">
                           <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">

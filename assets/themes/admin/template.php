            ...
            <div class="main-sidebar sidebar-style-2" tabindex="1" >
               <aside id="sidebar-wrapper">
                  <div class="sidebar-brand">
                     <a href="<?php echo base_url(); ?>" target="_blank"><strong>사용자 Home</strong></a>
                  </div>
                  ...
                  <ul class="sidebar-menu">
                     ...
                     <!-- 메뉴 콘텐츠 -->
                     <li class="dropdown <?php echo (strstr(uri_string(), 'admin/study') OR (strstr(uri_string(), 'admin/extcourse')) ) ? ' active' : ''; ?>">
                        <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                           <i class="fa fa-window-restore" aria-hidden="true"></i>
                           <span>콘텐츠</span>
                        </a>
                        <ul class="dropdown-menu">
                           <li class="<?php echo (uri_string() == 'admin/extcourse') ? 'active' : ''; ?>">
                              <a href="<?php echo base_url('admin/extcourse'); ?>" class="nav-link"> 캠핑장 추천
                              </a>
                           </li> 
                           <li class="<?php echo (uri_string() == 'admin/study') ? 'active' : ''; ?>">
                              <a href="<?php echo base_url('admin/study'); ?>" class="nav-link"> 캠핑스쿨
                              </a>
                           </li>                     
                        </ul>
                     </li>
                     ...
                     <!-- 메뉴 매거진 -->
                     <li class="dropdown<?php echo ((strstr(uri_string(), 'admin/settings/menu_item') OR uri_string() == 'admin/settings/menu_list') OR (strstr(uri_string(), 'admin/pages')) OR (strstr(uri_string(), 'admin/blog')) ) ? ' active' : ''; ?>">
                        <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                           <i class="fas fa-palette"></i> <span>매거진</span>
                        </a>
                        <ul class="dropdown-menu">
                           <li class="<?php echo ((uri_string() == 'admin/blog/post') OR (uri_string() == 'admin/blog/blog_post_form')) ? 'active' : ''; ?>">
                              <a href="<?php echo base_url('admin/blog/post'); ?>" class="nav-link"> 매거진 포스트
                              </a>
                           </li>
                           <li class="<?php echo ((uri_string() == 'admin/blog') OR (uri_string() == 'admin/blog/blog_category_form'))  ? 'active' : ''; ?>">
                              <a href="<?php echo base_url('admin/blog'); ?>" class="nav-link"> 매거진 카테고리
                              </a>
                           </li>
                        </ul>
                     </li>
                     ...
                     <li class="dropdown<?php echo (strstr(uri_string(), 'admin/institution') OR strstr(uri_string(), 'admin/course')) ? ' active' : ''; ?>">
                        ...
                        <ul class="dropdown-menu">
                           <li class="<?php echo (strstr(uri_string(), 'admin/institution')) ? 'active' : ''; ?>">
                              <a href="<?php echo base_url('admin/institution'); ?>" class="nav-link"> 캠핑장 테마
                              </a>
                           </li>
                           <li class="<?php echo (strstr(uri_string(), 'admin/course'))  ? 'active' : ''; ?>">
                              <a href="<?php echo base_url('admin/course'); ?>" class="nav-link">  태그
                              </a>
                           </li>
                        </ul>
                     </li>
                     ...
                     <!-- 메뉴 마케팅 -->
                     <li class="dropdown<?php echo (strstr(uri_string(), 'admin/template') OR (strstr(uri_string(), 'admin/adproduct')) OR (strstr(uri_string(), 'admin/advertisment')) OR (strstr(uri_string(), 'admin/sponsors')) ) ? ' active' : ''; ?>">
                        <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                        ...
                        <ul class="dropdown-menu">
                           <li class="<?php echo (strstr(uri_string(), 'admin/adproduct')) ? 'active' : ''; ?>">
                              <a href="<?php echo base_url('admin/adproduct'); ?>" class="nav-link"> 상품 링크
                              </a>
                           </li>            
                           <li class="<?php echo (strstr(uri_string(), 'admin/sponsors')) ? 'active' : ''; ?>">
                              <a href="<?php echo base_url('admin/sponsors'); ?>" class="nav-link"> 배너 광고
                              </a>
                           </li>                                              

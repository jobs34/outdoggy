...
/**
 * Base Online Class - Quiz 모듈에 쓰임
 * 
 */
class Online_Controller extends MY_Controller
{
    /**
     * Constructor
     */
    function __construct() {
        ...
        $this->template = "../../{$this->settings->themes_folder}/{$this->settings->theme}/quiztemplate.php";
    }
}

...
class MY_Controller extends CI_Controller {
    ...
    function __construct() {
        ...
        $site_version_array = json_decode(get_setting_value_by_name('update_info'));
        $this->settings->site_version = isset($site_version_array->current_version_name) && $site_version_array->current_version_name ? $site_version_array->current_version_name : "4.0.0";
        $this->settings->site_version_code = isset($site_version_array->current_version_code) && $site_version_array->current_version_code ? $site_version_array->current_version_code : 1;
        ...
        // set the time zone
        $timezones = date_default_timezone_set($this->settings->default_time_zone);
        // get current user
        ...
        if(empty($this->session->language))
        {
            ...
            $default_lang = $default_lang ? $default_lang : 'Korean';
        ...
        $this->session->language = $data_language ? $this->session->language : "Korean";
        ...
        $this->add_external_css(
            array(
                base_url("/{$this->settings->themes_folder}/admin/css/jquery.datetimepicker-full.css"),
        ))->add_external_js(
            array(
                ...
                base_url("/assets/libs/jquery/dist/jquery.js"),
                base_url("/{$this->settings->themes_folder}/admin/js/popper.js"),
                base_url("/{$this->settings->themes_folder}/admin/js/tooltip.js"),
                base_url("/{$this->settings->themes_folder}/admin/js/jquery.datetimepicker.full.min.js"),
            )
        );

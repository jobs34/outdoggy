    ...
    function __construct()
    {
        ...
        $this->add_external_css(
            array(
                ...
                base_url("/assets/themes/admin/css/summernote-bs4.min.css"),
                base_url("/assets/themes/admin/css/jquery.datetimepicker-full.css"),
            )
        );

        $this->add_external_js(
            array(
                base_url("/assets/themes/admin/js/jquery.min.js"),
                base_url("/assets/themes/admin/js/jquery-ui.min.js"),
                base_url("/assets/themes/admin/js/summernote-bs4.min.js"),
                base_url("/assets/themes/admin/js/tooltip.js"),
                ...
                base_url("/assets/themes/admin/js/jquery.datetimepicker.full.min.js"),              

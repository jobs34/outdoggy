...
/**
 * Base Public Class - used for all open pages
 */
class Open_Controller extends MY_Controller
{
    /**
     * Constructor
     */
    ...
    //    $this->add_css_theme("custom.css");
        ...
        $this->template = "../../{$this->settings->themes_folder}/{$this->settings->theme}/playtemplate.php";
    }
}

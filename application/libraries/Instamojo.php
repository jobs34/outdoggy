...
class Instamojo {	
    ...
    */
    ...
    {
    	$mode   = strtolower(get_admin_setting('instamojo_mode'));
		$apikey = get_admin_setting('instamojo_apikey');
		$token  = get_admin_setting('instamojo_token') ;
		$url    = base_url('instamojo/payment-status');

...
// Form Inputs
$lang['users input email']                    = "이메일";
$lang['users input first_name']               = "이름";
$lang['users input is_admin']                 = "Is Admin";
$lang['users input language']                 = "Language";
$lang['users input last_name']                = "직함";
$lang['users input password']                 = "비밀번호";
$lang['users input password_repeat']          = "비밀번호 확인";
$lang['users input user_image']               = "User Image";
$lang['users input status']                   = "Status";
$lang['users input username']                 = "아이디";
$lang['users input username_email']           = "아이디 또는 이메일";

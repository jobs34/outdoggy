...
class QuizController extends Admin_Controller {
    ...
    function question_list($quiz_id=false) 
    {
        ...
        foreach ($list as $question) {
            ...
            $button = '<a href="' . base_url("admin/questions/update/". $quiz_id. "/". $question->id) . '" target="_blank" data-toggle="tooltip"  title="'.lang("admin_edit_record").'" class="btn btn-primary btn-action mr-1"><i class="fas fa-pencil-alt"></i></a>';

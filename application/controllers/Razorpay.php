...
class Razorpay extends  Public_Controller{ //CI_Controller 
	...
	public function quiz_payment($purchases_type, $quiz_id, $payment_id)
	{
		...
		$content_data = array('data'=>$form_data, 'payment_id'=>$payment_id,'item_data' => $item_data,'Page_message' => $page_title, 'page_title' => $page_title,'purchases_type'=>$purchases_type,'quiz_id' => $quiz_id);

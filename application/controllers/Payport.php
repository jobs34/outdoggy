...
class Payport extends  Public_Controller{ //CI_Controller 
	...
	public function index($purchases_type,$quiz_id)
	{
		...
		{ 
			...
			$intent = \Stripe\PaymentIntent::create([
			 	...
			 	'metadata' => ['integration_check' => 'accept_a_payment'],
			  	...
			  	'shipping' => ['name' => $name,'address' => ['line1' => 'Dummy line','postal_code' => '342021','city' => 'Pink City','state' => 'CA','country' => 'US', ],],
			]);
			
			$customer = \Stripe\Customer::create([
				'name' => $name,
				'description' => $item_data->title.' (Stripe Payment)',
				'address' => ['line1' => 'Dummy line','postal_code' => '342021','city' => 'Pink City','state' => 'CA','country' => 'US',],
				]);
		}
		catch(Exception $e) 
		{
        ...
        $content_data = array('Page_message' => lang('Stripe Payment'), 'Stripe Payment' => lang('Stripe Payment'),'stripe_key' => $this->stripe_key,'quiz_id' => $quiz_id, 'item_data' => $item_data,'purchases_type'=> $purchases_type,'client_secret'=>$intent->client_secret,'txn_id' =>$intent->id,'user_name' => $user_name);

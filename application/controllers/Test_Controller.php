...
class Test_Controller extends Online_Controller {
    ...
    function test($quiz_id = NULL, $question_id = NULL) 
    {
        ...
        {
            $this->set_question_status($q_number,'mark_for_answer_and_next',$answer);
            return redirect(base_url("test/$quiz_id/$next_question"));
        }
        ...
        if(isset($question_data['question_type_is_match']))
        {
            ...
            {                
                $current_question_answers_arr_is_correct = $current_question_answers_arr['arr_is_correct'];  
                $current_question_display_order_array = $current_question_answers_arr['display_order_array'];  
    ...
    { 
        ...
        $content_data = array('Page_message' => lang('test_result'), 'page_title' => lang('test_result'),'correct' => $correct,'total_question' => $total_question, 'total_attemp' => $total_attemp, 'quiz_data' => $quiz_data, 'participant_data' => $participant_data, 'user_question_data' => $user_question_data ,'category_data'=>$category_data,'parent_category_data'=>$parent_category_data);

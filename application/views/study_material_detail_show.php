...
<?php 
    ...
    $adcourse_id = $study_data->adcourse_id;
    $adcourse_url = base_url('ad-course/').$adcourse_id."/lecture";
    if($adcourse_id >0){
        $adcourse_class= TRUE;
    }
    else{
        $adcourse_class= FALSE;
    }
...
<div class="pt-2 pt-lg-3 pb-4 min-h-100vh">
    <div class="container px-0">
        <div class="detail-content row">
            ...
            <div class="course-sidebar col-lg-4 col-md-12 col-12 pt-3 mb-6">
                <!-- 결제 관련 기본 정보 Card S-->
                        ...
                        <div class="pt-4 pb-4 list_title_btmbar">
                            ...
                            <div class="d-flex mt-1 mb-3 text-black font-weight-medium">
                             ...
                             <div class="d-flex mt-1 mb-3 text-black font-weight-medium">
                                ...
                                <div class="d-grid">
                                    <span class="text-black">수강기간 1년</span>
                                    <small class="text-medium-gray">신청 후 1년 동안 학습이 가능합니다.</small>
                                </div>
                            </div>      
                            <div class="d-flex mt-1 mb-3 text-black font-weight-medium">
                                <div class="ml-1 mr-3">
                ...
                if ($adcourse_class){
                ?>
                    <div class="card mb-4 mx-2 mx-md-0 bg-light-gray">
                        <!-- Card body S--> 
                        <div class="card-body"> 
                            <div class="pt-2 pb-1">
                                <p class="text-black mb-1 display-7">국비지원이 가능한 클래스</p>
                                <p class="text-dark-gray mb-1 font-size-sm">국민내일배움카드로 수강료를 지원받을 수 있어요.</p>
                            </div>
                            <div class="pt-2 pb-1">
                                <a href="<?php echo $adcourse_url; ?>" class="btn btn-secondary py-1 px-3 font-size-sm">국비지원 강좌 신청 바로가기 <i class="mdi mdi-arrow-right-bold-circle ml-2"></i></a>
                            </div>
                        </div>
                        <!-- Card body E-->
                    </div>

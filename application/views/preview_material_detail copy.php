        ...
        <div class="col-lg-9  order-md-1 p-0 bg-white" id="video_player_area">
            ...
            <div class="pt-0 pt-lg-2 pb-6 px-0 px-lg-3">
                <?php
                    ...
                    {
                    ?>
                        <div class="pt-4 pb-1 px-2 display-6">
                            <span class="font-weight-semi-bold text-primary herofont_L"><?php echo $study_material_content_title; ?></span>
                        </div>
                          ...
                          <?php
                            if($section_contant_data)
                            {
                                ...
                                { 
                                    ...
                                    <a href="<?php echo $this_contant_url; ?>" class="mb-3 d-flex justify-content-between align-items-center text-decoration-none">
                                        <div class="text-truncate pr-1">
                                            <span class="icon-shape bg-light text-primary icon-sm  rounded-circle mr-2"><i class="font-size-sm <?php echo $ico_type; ?>"></i></span>

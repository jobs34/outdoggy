		...
		<div class="row">
			<div class="col-12">
				<div class="pb-2 px-2 mt-1 mt-sm-0">
                    <span class="mt-0 display-6"><i class="bi bi-laptop fa-fw me-1"></i> 수강중인 클래스</span> <sapn class="pl-2 mt-0 pb-2 font-weight-bold text-light-gray">My Class</span>
				</div>
					...
					<div class="offcanvas-body p-3 p-xl-0">
						<div class="bg-dark border rounded-3 p-3 w-100">
							...
							<div class="list-group list-group-dark list-group-borderless collapse-list">
								...
								<a class="list-group-item active" href="<?php echo base_url('my/study')?>"><i class="bi bi-laptop fa-fw me-2"></i>수강중인 클래스</a>

<?php 
    ...
    $category_ext = $category_data->category_ext;
    $parent_category = $category_data->parent_category;    
  ?>

<div class="min-h-100vh">
    <!-- Bg cover -->
    <div class="py-6 bg-primary bg-opacity-10"></div>
    <!-- Page header -->
    <div class="bg-white shadow-sm">
        ...
        <div class="row align-items-center">
            ...
            <div class="d-md-flex align-items-center justify-content-between bg-white  pt-3 pb-3 pb-lg-5">
                ...
                <div class="mt-3 mt-md-n9">
                    <h1 class="mb-0 display-5 font-weight-bold mr-3"><?php echo $category_data->category_title; ?></h1>
                    <p class="mb-0 ml-1 lead"><?php echo $category_ext; ?></p>
                </div>
                <div>

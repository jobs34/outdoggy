  ...
  <div class="collapse navbar-collapse" id="navbarNav"> 
    <ul class="navbar-nav">
      ...
      <li class="nav-item <?php echo $material_file;?>">
        <a class="nav-link " href="<?php echo base_url('admin/study/material-file/'.$tab_study_material_id);?>"><?php echo lang('section_or_contant'); ?></a>
      </li>
      ...
      <li class="nav-item ">
        <a class="nav-link" href="<?php echo $sm_slug_url;?>" target="_blank"><?php echo lang('preview'); ?></a>
      </li>

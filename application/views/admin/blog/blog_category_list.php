...
<div class="panel panel-default">
   <a href="<?php echo base_url('admin/blog/blog_category_form');?>" class="btn btn-primary cat float-right" ><?php echo lang('admin_add_blog_category'); ?></a>
   <div class="clearfix"></div>
   <hr>
   <table id="blogcategorytable" class="display table table-striped table-bordered" cellspacing="0" width="100%">
      <thead>
         <tr>

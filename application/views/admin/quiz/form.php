          ...
          ?>
              ...
              <div class="col-3">
                  <div class="form-group">
                    <?php echo  form_label(lang('require_quiz_passing')." %", 'is_random'); ?><span class="text-danger"> *</span>
                    <?php 
                  ...
                  ?>
                    ...
                    <span class="small form-error w-100"> <?php echo strip_tags(form_error('passing_mark')); ?> </span>
              ...
              <div class="col-3">
                  ...
                  ?>
                    ...
                    <select name="reward_percentage" class="form-control select2 reward_percentage" id="reward_percentage">
                      <option value=""><?php echo lang('select_reward'); ?> %</option>
                      <?php 
                      for($i=1; $i <= 100; $i++)
                      {
                        $selected = $populateData == $i ? "selected" : "";
              ...
              <div class="col-3">
                  <div class="form-group <?php echo form_error('negative_marking_percentage_err') ? ' has-error' : ''; ?>">
                    <?php echo  form_label(lang('negative_marking_percentage'), 'negative_marking_percentage'); ?>
                    <?php 
                  ...
                  ?>
                    ...
                    <select name="negative_marking_percentage" class="form-control select2 negative_marking_percentage" id="negative_marking_percentage">
                      <option value=""><?php echo lang('select_negative_marking'); ?> %</option>
                      <?php 
                      for($i=1; $i <= 100; $i++)
                      {
                        $selected = $populateData == $i ? "selected" : "";
          ...
          <div class="col-3">
            <div class="form-group togle_button attempt "> 
              <?php echo  form_label(lang('allow_number_of_attempt_on_quiz'), 'quiz_attempt'); ?>
                <input type="number" name="quiz_attempt" id="quiz_attempt" class="form-control attempt" value="">
            </div>
          </div> 
